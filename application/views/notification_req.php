        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover" id="notif_req">
                <thead>
                <tr>
                  <th>Sender</th>
                  <th>Message</th>
                ...
                <tr>
                  ...
                  <td><a class="btn btn-block btn-xs" href="<?php echo base_url()?>web/read_notif_req?id=<?php echo $n->id ?>"> ganti status </a></td>
                </tr>
                  <?php } ?>
                </tbody>
              </table>
