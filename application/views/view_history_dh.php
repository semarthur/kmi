        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover" id="tablehistorydh">
                <thead>
                <tr>
                  <th>No. Ticket</th>
                  <th>Name</th>
                ...
                <tr>
                  ...
                  <td><a class="btn btn-block btn-xs" href="<?php echo base_url()?>web/see_details_history_dh?noticket=<?php echo $fd->noticket ?>"> SEE DETAILS </a></td>
                </tr>
                  <?php } ?>
                </tbody>
              </table>
