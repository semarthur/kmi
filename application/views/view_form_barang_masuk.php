      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo base_url(). 'crud/form_tambah_barang'; ?>" method="POST" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="nsb" placeholder="Masukkan nomor seri barang">
                </div>
                <div class="form-group">
                  <label for="datebeli">Tanggal Beli</label>
                  <input type="date" class="form-control" name="datebeli">
                </div>
                <div class="form-group">
                  <label for="kondisibeli">Kondisi Beli</label>
                  <select class="form-control" name="kondisibeli">
                    <option value="">Pilih salah satu</option>
                    <option value="Baru">Baru</option>
                    <option value="Bekas">Bekas</option>
                    <option value="Recondition/Refurbished">Recondition/Refurbished</option>
                  </select>
                </div>
                <div class="form-group">
