      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="<?php echo base_url().'web/profile_asm' ?>" >
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
        ...
        $userdata = $this->session->userdata('email');
        $koneksi = mysqli_connect("localhost","root","","newkmi");
        $onprocess = mysqli_query($koneksi,"SELECT COUNT(process) AS 'pop' FROM form WHERE process='On Process' AND e_mail LIKE \"%$userdata%\"");
        $approved_dh = mysqli_query($koneksi,"SELECT COUNT(approvalstatus) AS 'asdh' FROM form WHERE approvalstatus='Approved by Dept. Head' AND e_mail LIKE \"%$userdata%\"");
        $approved_am = mysqli_query($koneksi,"SELECT COUNT(approvalstatus) AS 'asam' FROM form WHERE approvalstatus='Approved by A. Manager' AND e_mail LIKE \"%$userdata%\"");
        $pending = mysqli_query($koneksi,"SELECT COUNT(approvalstatus) AS 'asp' FROM form WHERE approvalstatus='Pending' AND e_mail LIKE \"%$userdata%\"");
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover" id="tablehomeasm">
                <thead>
                <tr>
                  <th>No. Ticket</th>
                  <th>Name</th>
                ...
                <tr>
                  ...
                  <td><a class="btn btn-block btn-xs" href="<?php echo base_url()?>web/see_details_asm?noticket=<?php echo $f->noticket ?>"> SEE DETAILS </a></td>
                </tr>
                  <?php } ?>
                <tbody>
              </table>
