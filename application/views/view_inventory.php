      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <h4>Form Barang Edit</h4>
            </div>
            <a href="<?php echo base_url().'web/form_barang_edit' ?>" class="small-box-footer">Klik Disini <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
      </div>
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover" id="tableinventory">
                <thead>
                <tr>
                  <th>No. Inventaris</th>
                  <th>Nama</th>
                ...
                foreach($inventory as $i){
                  echo "<tr>";
                  echo "<td>".$i->noinventaris."</td>";
                  echo "<td>".$i->nama."</td>";
                  echo "<td>".$i->merk."</td>";
                  echo "<td>".$i->noseribarang."</td>";
                  echo "<td>".$i->tgl_beli."</td>";
                  echo "<td>".$i->kond_beli."</td>";
                  echo "<td>".$i->kond_barang."</td>";
                  echo "<td>".$i->tgl_keluar."</td>";
                  echo "<td>".$i->tmpt_pasang."</td>";
                  echo "<td>".$i->tgl_rusak."</td>";
                }
                ?>
                </tbody>
              </table>
