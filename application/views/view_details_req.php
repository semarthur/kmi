            ...
            <form role="form" action="" method="GET">
              ...
              <div class="box-footer">
                  <?php if($details[0]->process == "Not Processed") {?>
                    <a class="btn btn-primary" href="<?php echo base_url()?>web/form_revision_req?noticket=<?php echo $details[0]->noticket ?>" >FORM REVISION</a> &nbsp <input type="submit" value="Download" name="download" class="btn btn-primary">
                  <?php } else {?>
