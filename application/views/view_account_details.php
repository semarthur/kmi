      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo base_url().'crud/update_profile' ?>" method="POST">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="email" class="form-control" name="e_mail" value="<?php echo $akun->email; ?>" readonly>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="notlp" value="<?php echo $akun->telepon; ?>">
                </div>
              </div>
              <!-- /.box-body -->
