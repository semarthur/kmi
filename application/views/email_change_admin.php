...
<body>
    ...
    $noticketlast = mysqli_query($koneksi,"SELECT noticket AS 'hasil' FROM form ORDER BY update_at DESC LIMIT 1");
                ...
                <table>
                    ...
                    <tr>
                        <td class="content">
                            ...
                            <center><h2>Hi <?php echo $this->session->userdata('email') ?></h2></center>

                            <center><p>Your Requisition Form is on process. You are from Information System.</p>
                            <p>Your ticket number <?php echo $printcn = $convertnoticket['hasil'] ?></p></center>

                            <table>
                                <tr>
                                    <td align="center">
                                        <p>
                                            <a href="http://localhost/kmi/" class="link">CHECK HERE</a>
                                        </p>
                                    </td>
                                </tr>
                            </table>
