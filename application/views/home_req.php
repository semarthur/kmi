      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="<?php echo base_url().'web/profile_req' ?>" >
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover" id="tablehomereq">
                <thead>
                <tr>
                  <th>No. Ticket</th>
                  <th>Name</th>
                ...
                <tr>
                  ...
                  <td><a class="btn btn-block btn-xs" href="<?php echo base_url()?>web/see_details_req?noticket=<?php echo $f->noticket ?>"> SEE DETAILS </a></td>
                </tr>
                  <?php } ?>
                </tbody>
              </table>
