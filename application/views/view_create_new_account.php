      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo base_url().'crud/create_profile' ?>" method="POST">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="email" class="form-control" name="e_mail" placeholder="Enter e-mail">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" name="notlp" placeholder="Enter Telephone Number">
                </div>
              </div>
              <!-- /.box-body -->
